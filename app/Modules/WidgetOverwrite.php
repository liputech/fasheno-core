...
class WidgetOverwrite {
	...
	public function __construct() {
		...
		add_action( 'in_widget_form', [ $this, 'fasheno_in_widget_form' ], 5,
			3 );
		//Callback function for options update (priorität 5, 3 parameters)
		add_filter( 'widget_update_callback',
			[ $this, 'fasheno_in_widget_form_update' ], 5, 3 );
		//add class names (default priority, one parameter)
		add_filter( 'dynamic_sidebar_params',
			[ $this, 'fasheno_dynamic_sidebar_params' ] );
	}

	function fasheno_in_widget_form( $t, $return, $instance ) {
	...
	function fasheno_in_widget_form_update(
	...
	function fasheno_dynamic_sidebar_params( $params ) {
