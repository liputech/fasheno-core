...
namespace RT\FashenoCore\Abstracts;
...
use RT\FashenoCore\Elementor\Controls\ImageSelectorControl;
use RT\FashenoCore\Elementor\Controls\Select2AjaxControl;
...
abstract class ElementorWidgetBase extends Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		$this->fasheno_category = FASHENO_CORE_PREFIX . '-widgets'; // Category /@dev
		$this->fasheno_icon     = 'rdtheme-el-custom';
	}
	...
	protected function register_controls() {
		...
		foreach ( $fields as $id => $field ) {
			$field['classes'] = ! empty( $field['classes'] ) ? $field['classes'] . ' elementor-control-fasheno_el' : ' elementor-control-fasheno_el';
		...
		do_action( 'fasheno/after/register/controls' );
	}
