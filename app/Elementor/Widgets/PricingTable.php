...
class PricingTable extends ElementorBase {
	...
	public function __construct($data = [], $args = null) {
		$this->rt_name = esc_html__('RT Pricing Table', 'fasheno-core');
	...
	protected function register_controls() {
		$this->start_controls_section(
			'rt_pricing_table',
			[
				'label' => esc_html__('Pricing Table Settings', 'fasheno-core'),
		...
		$this->add_control(
			'layout',
			[
				'label'   => esc_html__( 'Style', 'fasheno-core' ),
		...
		$this->add_control(
			'title',
			[
				'label' => esc_html__('Plan Name', 'fasheno-core'),
		...
		$this->add_control(
			'price',
			[
				'label' => esc_html__('Price', 'fasheno-core'),
				'type' => Controls_Manager::TEXT,
				'default' => '$29.00',
				'label_block' => false,
			]
		...
		$this->add_control(
			'period',
			[
				'label' => esc_html__('Period', 'fasheno-core'),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'faature_title' => __('Sync between pages', 'fasheno-core'),
						'list_icon' => 'fas fa-check',
					],
					[
						'faature_title' => __('Powerful database store', 'fasheno-core'),
						'list_icon' => 'fas fa-check',
					],
					[
						'faature_title' => __('Free / Pro Ads', 'fasheno-core'),
						'list_icon' => 'fas fa-check',
					],
					[
						'faature_title' => __('Unlimited guests', 'fasheno-core'),
						'list_icon' => 'fas fa-check',
					],
					[
						'faature_title' => __('Version history', 'fasheno-core'),
						'list_icon' => 'fas fa-check',
					],
				],
		...
		$this->start_controls_section(
			'additional_settings',
			[
				'label' => esc_html__('Additional Settings', 'fasheno-core'),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_html__('This color will work if you don\'t set color from the list', 'fasheno-core'),
			]
		);
		...
		$this->start_controls_section(
			'image_icon_settings',
			[
				'label' => esc_html__('Image / Icon Settings', 'fasheno-core'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__('Image/Icon Size', 'fasheno-core'),
				'size_units' => ['px'],
				'range' => [
					'px' => [
						'min' => 20,
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__('X Position', 'fasheno-core'),
				'size_units' => ['px', '%'],
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__('Y Position', 'fasheno-core'),
				'size_units' => ['px', '%'],
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__('Image/Icon Opacity', 'fasheno-core'),
				'size_units' => ['px'],
				'range' => [
					'px' => [
						'min' => 0.1,
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__('Image/Icon Opacity Hover', 'fasheno-core'),
				'size_units' => ['px'],
				'range' => [
					'px' => [
						'min' => 0.1,
