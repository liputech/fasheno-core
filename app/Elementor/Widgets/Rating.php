...
class Rating extends ElementorBase {
	...
	public function __construct( $data = [], $args = null ) {
		$this->rt_name = esc_html__( 'RT Rating', 'fasheno-core' );
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => __( 'Ratings', 'fasheno-core' ),
			]
		);
		...
		$this->start_controls_section(
			'rating_style',
			[
				'label' => esc_html__( 'Rating Style', 'fasheno-core' ),
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Rating Number Style', 'fasheno-core' ),
		...
		$this->add_control(
			'number_space',
			[
				'label'      => __( 'Number Space', 'fasheno-core' ),
		...
		$this->add_control(
			'star_style_heading',
			[
				'label'     => __( 'Rating Star Style', 'fasheno-core' ),
				'type'      => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Rating Label Style', 'fasheno-core' ),
				'type'      => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'rating_label_space',
			[
				'label'      => __( 'Label Space', 'fasheno-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
