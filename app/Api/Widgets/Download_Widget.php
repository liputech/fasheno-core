...
class Download_Widget extends WP_Widget {
	...
	public function __construct() {
		$id    = FASHENO_CORE_PREFIX . '_download';
		$title = __( 'Fasheno: Download', 'fasheno-core' );
		$args  = [
			'description' => esc_html__( 'Displays Download Info', 'fasheno-core' )
		];
	...
	public function form( $instance ) {
		...
		$fields = [
			...
			'down_title'       => [
				'label'   => esc_html__( 'Download Title', 'fasheno-core' ),
				'type'    => 'text',
			],
			'down_url'    => [
				'label'    => esc_html__( 'Download URL', 'fasheno-core' ),
				'type'     => 'url',
			],
			'doc_title'       => [
				'label'   => esc_html__( 'Document Title', 'fasheno-core' ),
				'type'    => 'text',
			],
			'doc_url'    => [
				'label'    => esc_html__( 'Document URL', 'fasheno-core' ),
				'type'     => 'url',
			],
		];
