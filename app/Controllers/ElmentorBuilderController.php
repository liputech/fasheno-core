...
class ElmentorBuilderController {
	...
	public static $post_type = 'elementor-fasheno';
	...
	public function __construct() {
		...
		//add_action( "save_post_{self::$post_type}", [ $this, 'save_el_fasheno' ] );
	...
	public function header_footer_posttype() {
		$labels = [
			'name'               => __( 'Header & Footer Builder', 'fasheno-core' ),
			'singular_name'      => __( 'Header & Footer Builder', 'fasheno-core' ),
			'menu_name'          => __( 'Header & Footer Builder', 'fasheno-core' ),
			'name_admin_bar'     => __( 'Header & Footer Builder', 'fasheno-core' ),
			'add_new'            => __( 'Add New', 'fasheno-core' ),
			'add_new_item'       => __( 'Add New Header or Footer', 'fasheno-core' ),
			'new_item'           => __( 'New Template', 'fasheno-core' ),
			'edit_item'          => __( 'Edit Template', 'fasheno-core' ),
			'view_item'          => __( 'View Template', 'fasheno-core' ),
			'all_items'          => __( 'All Templates', 'fasheno-core' ),
			'search_items'       => __( 'Search Templates', 'fasheno-core' ),
			'parent_item_colon'  => __( 'Parent Templates:', 'fasheno-core' ),
			'not_found'          => __( 'No Templates found.', 'fasheno-core' ),
			'not_found_in_trash' => __( 'No Templates found in Trash.', 'fasheno-core' ),
		];
	...
	public function save_el_fasheno( $post_id ) {
	...
	public function override_header() {
		require FASHENO_CORE_BASE_DIR . 'templates/builder/header.php';
		$templates   = [];
	...
	public function override_footer() {
		require FASHENO_CORE_BASE_DIR . 'templates/builder/footer.php';
		$templates   = [];
	...
	function hfe_render_header() {
		if ( false == apply_filters( 'fasheno_header_builder_enable', true ) ) {
			return;
		}
	...
	function hfe_render_footer() {
		...
		if ( false == apply_filters( 'fasheno_footer_builder_enable', true ) ) {
			return;
		}
		?>
